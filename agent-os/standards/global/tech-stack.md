...
### Framework & Runtime
- **Application Framework:** [e.g., Spring boot, Rails, Django, Next.js, Express]
- **Language/Runtime:** [e.g., Kotlin, Ruby, Python, Node.js, Java]
- **Package Manager:** [e.g., gradle, bundler, pip, npm, yarn]
...
- **CI/CD:** [e.g., Gitlab CI, GitHub Actions, CircleCI]
